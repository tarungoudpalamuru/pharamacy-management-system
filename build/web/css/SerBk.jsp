...
.button:hover span:after {
  ...
  right: 0;
    ...
    <nav class="codrops-demos">
        <a>Student Regno :  <input type="text" name="stdrg" value=""/></a>&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
<!--      <a>Book Name  :  <input type="text" name="bknm" value=""/></a>&nbsp;&nbsp;&nbsp;&nbsp;<br><br>-->
        <button class="button" type="submit" name="Student Status" style="vertical-align:middle"><span>Student Status </span></button>
<!--        <button class="button" type="submit" name="Book Search" style="vertical-align:middle" onclick="form.action='SerBk.jsp';"><span>Book Search </span></button>-->
			...
			<div class="component">
				...
				<table>
                    ...
                    %>
                    <tr>
                        <td><input type="radio" name="bk1" value="<%=rs1.getString("sno")%>" > </td>
                        
                        <td><%=rs1.getString("stdrg") %></td>
                        <td><%=rs1.getString("bknm") %></td>
                        <td><%=rs1.getString("bkid") %></td>
                        <td><%=rs1.getString("bkdpt") %></td>
                        <td><%=rs1.getString("bdate") %></td>
                         <td><%=rs1.getString("rdate") %></td>
                        <td><%=rs1.getString("bkcnt") %></td>
                ...
                <button class="button" type="submit" name="Book Search" style="vertical-align:middle" onclick="form.action='RenBk';"><span>Book Renewal </span></button>
		...
		<script src="js/jquery.stickyheader.js"></script>
                ...
                <a href="StdAct.jsp" class="button" style="vertical-align:middle">Exist</a>
	</body>
</html>