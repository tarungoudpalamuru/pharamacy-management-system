 ...
 * @author Anju
 */
@WebServlet(urlPatterns = {"/Ownerreg"})
public class Ownerreg extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String s1=request.getParameter("username");
           ...
           String s5=request.getParameter("shopname");
            ...
            try
       {
           ...
           int rs=st.executeUpdate("Insert into pharmacyowner(username,password,emailid,mobileno,shopname,address) Values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"')");
           if(rs>0)
           {
